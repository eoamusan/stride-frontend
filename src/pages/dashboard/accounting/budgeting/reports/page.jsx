        ...
        { !isLoading && <>
          <div className="relative mt-10 bg-white p-6 rounded-2xl">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-2'>
              <VarianceCard title="Marketing Budget Overrun" description="6.25% over budget ($50K excess)" className="bg-red-100  text-red-900" />
              <VarianceCard title="HR Budget On Track" description="2.22% under budget, excellent performance" className="bg-green-100  text-green-900"  />
              <VarianceCard title="Sales Budget Warning" description="Approaching 90% of budget limit" className="bg-orange-100  text-orange-900"  />
            </div>
          </div>
