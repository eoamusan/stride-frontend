  ...
  return (
    <Dialog open={open} onOpenChange={(value) => !value && onClose?.()}>
      ...
      >
        ...
        <div className="flex-1 overflow-auto bg-[#F5F6FA] p-4 md:p-8">
          <div className="bg-white px-6 py-6">
            ...
            <div className="pt-3 text-sm text-gray-800">
              ...
              <div className="grid gap-6 py-3 text-xs text-gray-600 md:grid-cols-2">
                <div className="space-y-2">
        ...
        <div className="flex flex-col items-center gap-3 px-6 py-10 md:flex-row md:justify-end">
          <CustomButton
            variant="outline"
            onClick={onDownload}
            // className="w-full"
          ...
          <CustomButton onClick={onRelease}>Download PDF</CustomButton>
        </div>
      </DialogContent>
    </Dialog>
  );
