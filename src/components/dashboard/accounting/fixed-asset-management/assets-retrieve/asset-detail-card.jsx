...
const AssetDetailCard = ({ isSelected, handleSelect, data, setShowDetails }) => {
            ...
            <div className='flex flex-col gap-1'>
              ...
              <div className='text-gray-400 text-xs'>
                <div className='grid grid-cols-1 font-medium'>
                  <span>MBP2024001</span>
                  <span>Building</span>
                </div>
              </div>
            </div>

            <span className='flex flex-col items-end font-medium text-xs'>
              { data?.budgetAmount }
              <div className='w-17 space-y-1'>
                15000
                <ProgressBar variant='success' value={80} className="h-0.5" />
                <span>Good</span>
              </div>
            </span>
          </div>
