...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar overflow-visible p-3 [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'size-[34px] p-0 select-none aria-disabled:opacity-50',
        ...
        dropdowns: cn(
          'relative flex h-(--cell-size) w-full items-center justify-center gap-2 overflow-visible text-sm font-medium',
          defaultClassNames.dropdowns
        ),
        dropdown_root: cn(
          'has-focus:border-ring border-input has-focus:ring-ring/50 relative rounded-md border px-4 py-0.5 shadow-xs has-focus:ring-[3px]',
